...
run_knn <- function(data_train_X_miss, data_test_X_miss, y_train, y_test,
  ...
  imputed_dfs <- impute_knn(data_train_X_miss, data_test_X_miss)
  data_train_imp <- imputed_dfs$data_train_imp_knn #%>% as.data.frame()
  data_test_imp <- imputed_dfs$data_test_imp_knn #%>% as.data.frame()
